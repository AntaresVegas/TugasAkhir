...
\textit{Hypertext Markup Language} (HTML) merupakan bahasa markup yang digunakan untuk menyusun struktur dasar halaman web. HTML tidak termasuk bahasa pemrograman, melainkan bahasa yang digunakan untuk mendeskripsikan bagaimana konten ditampilkan pada browser\cite{duckett:11:htmlcss}. HTML memungkinkan pengembang untuk mengatur berbagai jenis konten seperti teks, gambar, tautan, tabel, dan elemen multimedia lainnya.
...
\begin{figure} [H]
	\centering  
	\includegraphics[scale=0.3]{Skripsi/DokumenSkripsi/Gambar/TagHTML.png}
...
Metode ini sangat cocok untuk struktur berbentuk tree seperti DOM karena mengikuti pola parent-child secara mendalam. DFS sering digunakan untuk eksplorasi struktur hierarkis dan graf\cite{cormen:22:introalgo}.
